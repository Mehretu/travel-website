      ...
      <div className="flex h-full flex-col items-start justify-between p-6 lg:px-20 lg:py-10 ">
        ...
        <div className="flexCenter gap-6">
          <span className="flex -space-x-4 overflow-hidden">
            {PEOPLE_URL.map((url) => (
              <Image className="inline-block h-10 h-10 w-10 rounded-full "
                src={url}
                key={url}
                alt="person"
                width={52}
  ...
  return (
    <section className='2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20 '>
      ...
      <div className="flexEnd mt-10 lg:-mt-60 px-6  lg:mr-6">
        <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
